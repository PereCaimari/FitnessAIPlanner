...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main className="main-content">
      ...
      {section === 'planner' && <Planner answers={plannerAnswers} setAnswers={setPlannerAnswers} step={plannerStep} setStep={setPlannerStep} onGenerate={generatePlan} onSavePlan={saveGeneratedPlan} plan={plan} planSaving={planSaving} planSaved={planSaved} />}
