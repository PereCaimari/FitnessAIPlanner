...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main className="main-content">
      ...
      {section === 'planner' && <Planner answers={plannerAnswers} setAnswers={setPlannerAnswers} step={plannerStep} setStep={setPlannerStep} onGenerate={generatePlan} plan={plan} />}
...
function Planner({ answers, setAnswers, step, setStep, onGenerate, plan }: { answers: PlannerAnswers; setAnswers: React.Dispatch<React.SetStateAction<PlannerAnswers>>; step: number; setStep: (step: number) => void; onGenerate: () => void; plan: AiPlanResponse | null }) {
